---
article_id: BTK-15-03
title: "Tanda Rayap, Bubuk, Jamur, dan Pelapukan"
slug: "diagnosis-kerusakan-biologis-bambu"
...
date_modified: null
parent_topic: BTK-15
primary_intent: "Identify biological deterioration"
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/diagnosis-kerusakan-biologis-bambu.html"
...
# Tanda Rayap, Bubuk, Jamur, dan Pelapukan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Tanda Rayap, Bubuk, Jamur, dan Pelapukan”
...
- **Primary intent:** Identify biological deterioration
...
- **Scope boundary:** Treatment response requires verified diagnosis/product guidance
- **Final public route:** `/artikel/diagnosis-kerusakan-biologis-bambu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tanda Rayap, Bubuk, Jamur, dan Pelapukan**.
...
- `BTK-15-01` → `/artikel/checklist-inspeksi-bangunan-bambu.html` — Checklist Inspeksi Bangunan Bambu
- `BTK-15-02` → `/artikel/diagnosis-retak-bambu.html` — Retak, Belah, dan Pecah pada Batang Bambu
- `BTK-15-04` → `/artikel/diagnosis-sambungan-struktur-bambu.html` — Sambungan Longgar dan Deformasi Struktur Bambu
...
- **Tie back to this article:** Keep the explanation specific to “Tanda Rayap, Bubuk, Jamur, dan Pelapukan”.
