---
article_id: BTK-14-04
title: "Mockup Sambungan dan Finishing sebelum Produksi"
slug: "mockup-konstruksi-bambu"
...
date_modified: null
parent_topic: BTK-14
primary_intent: "Validate workmanship intent"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/mockup-konstruksi-bambu.html"
...
# Mockup Sambungan dan Finishing sebelum Produksi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mockup Sambungan dan Finishing sebelum Produksi”
...
- **Primary intent:** Validate workmanship intent
...
- **Scope boundary:** Mockup is not proof of structural capacity
- **Final public route:** `/artikel/mockup-konstruksi-bambu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mockup Sambungan dan Finishing sebelum Produksi**.
...
- `BTK-14-03` → `/artikel/shop-drawing-konstruksi-bambu.html` — Shop Drawing dan Detail Fabrication Bambu
- `BTK-14-05` → `/artikel/qa-konstruksi-bambu.html` — Checklist QA Fabrikasi dan Erection Bambu
- `BTK-14-06` → `/artikel/serah-terima-proyek-bambu.html` — Dokumen Serah Terima Proyek Bambu
...
- **Tie back to this article:** Keep the explanation specific to “Mockup Sambungan dan Finishing sebelum Produksi”.
